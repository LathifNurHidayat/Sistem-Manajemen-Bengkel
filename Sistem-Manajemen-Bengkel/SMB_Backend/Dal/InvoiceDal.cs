    ...
    public class InvoiceDal
    {
        ...
        {   
            const string sql = @"SELECT 
                                ...
                                k.no_polisi, 
                                b.antrean, 
                                js.jenis_servis AS barang_jasa, 
                                sp.nama_sparepart AS barang_jasa,
                                js.biaya AS harga, 
                                ps.jumlah AS quantity,
                            ...
                            GROUP BY 
                                ...
                                js.jenis_servis, sp.nama_sparepart, js.biaya, ps.jumlah, 
                                b.catatan, ib.nama_bengkel, ib.alamat, ib.email, ib.no_telp, b.tanggal";
